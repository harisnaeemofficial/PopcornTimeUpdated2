...
import com.movieflix.base.model.video.info.AnimeMoviesInfo;
import com.movieflix.base.model.video.info.AnimeTvShowsInfo;
...
import com.movieflix.base.subtitles.SubtitlesFontColor;
import com.movieflix.base.subtitles.SubtitlesFontSize;
import com.movieflix.base.subtitles.SubtitlesLanguage;
import com.movieflix.base.torrent.TorrentService;
import com.movieflix.base.torrent.client.BaseClient;
import com.movieflix.base.utils.DeviceUtils;
...
import com.movieflix.mobile.model.content.ContentType;
import com.movieflix.mobile.model.content.MoviesProvider;
import com.movieflix.mobile.model.content.SubtitlesProvider;
import com.movieflix.mobile.model.content.SubtitlesRepository;
import com.movieflix.mobile.model.content.TmdbProvider;
import com.movieflix.mobile.model.content.TvShowsProvider;
import com.movieflix.mobile.model.content.TvShowsSeasonsProvider;
import com.movieflix.mobile.model.filter.FilterItemView;
import com.movieflix.mobile.model.filter.FilterView;
import com.movieflix.mobile.model.settings.SettingsRepository;
import com.movieflix.mobile.ui.SettingsActivity;
import com.movieflix.model.ChoiceProperty;
import com.movieflix.model.Property;
import com.movieflix.model.config.Config;
import com.movieflix.model.config.ConfigLocalRepository;
import com.movieflix.model.config.ConfigRemoteRepository;
import com.movieflix.model.config.ConfigUseCase;
import com.movieflix.model.config.IConfigUseCase;
import com.movieflix.model.config.StaticConfig;
import com.movieflix.model.content.ContentUseCase;
...
import com.movieflix.model.details.DetailsUseCase;
import com.movieflix.model.details.IDetailsUseCase;
import com.movieflix.model.filter.FilterItem;
import com.movieflix.model.filter.IFilter;
import com.movieflix.model.messaging.IMessagingData;
import com.movieflix.model.messaging.IMessagingNotificationData;
import com.movieflix.model.messaging.IMessagingUseCase;
import com.movieflix.model.messaging.MessagingUseCase;
import com.movieflix.model.messaging.MessagingUtils;
import com.movieflix.model.settings.ISettingsUseCase;
import com.movieflix.model.settings.SettingsUseCase;
import com.movieflix.model.share.IShareUseCase;
import com.movieflix.model.share.ShareRemoteRepository;
import com.movieflix.model.share.ShareUseCase;
import com.movieflix.model.subtitles.Subtitles;
import com.movieflix.model.updater.IUpdaterRepository;
import com.movieflix.model.updater.IUpdaterUseCase;
import com.movieflix.model.updater.Update;
import com.movieflix.model.updater.UpdaterUseCase;
import com.movieflix.mvp.IViewRouter;
import com.movieflix.ui.IBrowserView;
import com.movieflix.ui.ISystemShareView;
import com.movieflix.ui.locale.ILocalePresenter;
import com.movieflix.ui.locale.LocalePresenter;
...
public final class PopcornApplication extends Application implements IPopcornApplication,
    ...
    public static final String ACTION_NOTIFICATION = "com.movieflix.mobile.ACTION_NOTIFICATION";
    ...
    public void onCreate() {
        ...
        final SharedPreferences movieflixPreferences = getSharedPreferences("MovieFlixPreferences", Context.MODE_PRIVATE);
        ...
        configUseCase = new ConfigUseCase(
                config,
                new ConfigLocalRepository(movieflixPreferences),
                new ConfigRemoteRepository()
        );
        StaticConfig.APP_ID = BuildConfig.APP_ID;
        StaticConfig.setConfig(configUseCase.getConfig());

        final String[] SUBTITLES_LANGUAGES = getResources().getStringArray(com.movieflix.base.R.array.subtitles_name);
        ...
        settingsUseCase = new SettingsUseCase(
                ...
                SPEEDS,
                SPEEDS,
                new SettingsRepository(movieflixPreferences)
        );
    ...
    private void createNotificationChannels() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            String channelId2 = "movieflix_download_info";
            ...
            String channelId4 = "movieflix_message";
            ...
            String channelId5 = "movieflix_media_control";
            ...
            String channelId3 = "movieflix_state_info";
    ...
    public void onShowMessagingNotification(@NonNull IMessagingNotificationData data) {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(PopcornApplication.this, "movieflix_message");
